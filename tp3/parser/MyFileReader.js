...
class MyFileReader  {
	...
	*/
	...
	loadNode(nodeElement) {
		...
		let maxSpeed = this.getFloat(nodeElement, "maxSpeed", false);
		let acceleration = this.getFloat(nodeElement, "acceleration", false);
		let deceleration = this.getFloat(nodeElement, "deceleration", false);
		let raio = this.getFloat(nodeElement, "raio", false);
		...
		obj.raio = (raio !== null ? raio : 0);
		obj.maxSpeed = (maxSpeed !== null ? maxSpeed : 0);
		obj.acceleration = (acceleration !== null ? acceleration : 0);
		obj.deceleration = (deceleration !== null ? deceleration : 0);
