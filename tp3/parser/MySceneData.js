...
class MySceneData  {
    ...
    createEmptyNode(id) {
		...
		obj = {id: id, maxSpeed:0, acceleration:0, deceleration:0, raio: 0, transformations: [], materialIds : [], children: [], loaded: false, type:"node", castShadows: false, receiveShadows: false};
        this.addNode(obj);
        return obj;
	}
